...
class GephiOutput(Output):
    ...
    def generate_nodes(self):
        ...
        output.append(u'nodedef> {0}'.format(fields))
        ...
        for node in self.processor.nodes():
            fields = u','.join([str(a) for a in [
                ...
                u"'{0}'".format(self.node_color_func(node).rgb_csv()),
                self.node_size(node),
            ]])
    ...
    def generate_edges(self):
        ...
        output.append(u'edgedef> {0}'.format(fields))
        ...
        for edge in self.processor.edges():
            fields = u','.join([str(a) for a in [
                ...
                'true',
                'true',
                u"'{0}'".format(self.edge_color_func(edge).rgb_csv()),
